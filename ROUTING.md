...
## Thinking & Reasoning
Read `skills/meta-cognitive/ROUTING.md` when: problem-solving, decision-making, creative work, strategic thinking, evaluating options, prioritizing, or building/updating skills and the soul file.

## Communication
Read `skills/communication/ROUTING.md` when: writing Slack messages, communicating with leadership, delivering difficult messages, or any situation where tone, formatting, and message structure matter.
